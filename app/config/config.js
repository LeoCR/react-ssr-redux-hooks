...
db.pokemon = require(path.resolve(__dirname+'/../model/pokemon.model.js'))(sequelize, Sequelize);
db.ability = require(path.resolve(__dirname+'/../model/ability.model.js'))(sequelize, Sequelize);
db.place = require(path.resolve(__dirname+'/../model/place.model.js'))(sequelize, Sequelize);
